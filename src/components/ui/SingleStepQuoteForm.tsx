  ...
  return (
    <form onSubmit={handleSubmit} noValidate aria-label="Request same-day HVAC service">
      ...
      <div className="flex flex-col gap-3">
        ...
        {/* SMS consent — optional per A2P 10DLC compliance */}
        <div className={`p-3 rounded-xl border ${variant === "dark" ? "border-white/15" : "border-slate-200"} ${variant === "dark" ? "bg-white/5" : "bg-slate-50"}`}>
          <SmsConsentCheckbox
            id={`${id}-sms-consent`}
