  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-hvac-blue-200 text-xs font-medium">{SITE.phoneDisplay}</span>
      </a>
      <Link
        href="/contact"
        className="flex-1 flex flex-col items-center justify-center gap-0.5 py-3.5 bg-copper-gradient text-white active:opacity-90 transition-opacity"
      ...
      >
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-bold text-sm">Free Estimate</span>
        </div>
        <span className="text-orange-100 text-xs font-medium">No obligation</span>
      </Link>
    </div>
  );
}
